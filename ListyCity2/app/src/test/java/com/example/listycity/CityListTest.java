...
public class CityListTest {
    ...
    void testHasCity(){
        ...
        assertEquals(true, cityList.hasCity(existingCity));

        City nonExistingCity = new City("Toronto", "Ontario");
        assertEquals(false, cityList.hasCity(nonExistingCity));
    }
    ...
    void testDelete() {
        ...
        assertEquals(true, cityList.hasCity(cityToDelete));

        cityList.delete(cityToDelete);
        assertEquals(false, cityList.hasCity(cityToDelete));
    }
